...
- [x] 06-02-PLAN.md — Newsletter subscribe (table migration, API route, confirmation email, home page form)
- [x] 06-03-PLAN.md — Newsletter unsubscribe (API route, confirmation page at /unsubscribe?token=UUID)
